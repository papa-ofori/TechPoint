...
?>
  <nav>
    ...
    <a href="../View/products.php">Back to Products</a>
    ...
    <div class="photo">
    <img style='height:200px; width: 230px;' src="../images/<?php echo $one_product['product_image']; ?>">
  </div>
  <div class="description">
    ...
    <button onclick="fireSweetAlert()">Add to Cart</button>
