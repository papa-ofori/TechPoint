    ...
    <div class="form_wrapper">
        <div class="form_container">
            ...
            <div class="row clearfix">
                <div class="">
                    <form name="myForm" action="regisproc.php" method="POST" onsubmit="return(validate());">
                        ...
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                            <input type="password" name="upass1" id="upass1" placeholder="Re-type Password" required />
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col_half">
                                <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                                    <input type="text" name="lname" name="lame" placeholder="Last Name" required />
                                </div>
                            </div>
                            ...
                            <div class="col_half">
                                <div class="input_field"> <span><i aria-hidden="true" class="fa fa-building"></i></span>
                                    <input type="text" name="cty" id="cty" placeholder="City" />
                                </div>
                            </div>
                            ...
                            <div class="col_half">
                                <div class="input_field"> <span><i aria-hidden="true" class="fa fa-phone"></i></span>
                                    <input type="text" name="phn" name="phn" placeholder="Contact Number" required />
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Gender -->
                    <div class="input_field radio_option" required>
                    ...
                    <div class="input_field checkbox_option">
                        ...
                        <p class="credit"><a href="login.php" target="_blank">I have an account</a></p>
                    </div>
                    <input class="button" type="submit" name="regBtn" value="Register" />
                </form>
            </div>
        </div>
    </div>
