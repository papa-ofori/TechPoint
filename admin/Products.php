				...
				<tbody>
					<div>
						...
						foreach ($product_list as $product) {
							...
							<form action='../actions/delProd.php' method='POST'>
                 <input type='hidden' value='$pid' name='pid'>
                 <br><button type='submit' name='del'style='margin-top:-93px; margin-left:150px;'  class='btn btn-danger btn-sm remove'>Delete</button>
                 </form>
							</td>
							</tr>";
						}
