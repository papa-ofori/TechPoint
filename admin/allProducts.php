...
<body style="overflow-y:scroll;">
  ...
  <div class="container py-5">
    ...
    <header class="text-center mb-5">
      ...
      <p class="font-italic text-muted mb-0">Quatilty products from the leading technology industries such as Apple,Google,Samsung and others</p>
    ...
    <div class="container">
      <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        foreach ($product_list as $product) {
          ...
          <img src='../images/$pimg' alt='$pname' style='height:300px; width:333px;' >
          <div class='card-body'>
          <center>
          <h5> <a href='singleProduct.php?pid=$pid' class='text-dark'>$pname</a></h5>
          ...
          <a href='singleProduct.php?pid=$pid' class='btn btn-info'>View Product</a>
